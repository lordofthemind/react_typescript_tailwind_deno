    ...
    return (
        <Base title="About">
            <div className="p-8 bg-white shadow rounded-xl space-y-4">
                ...
                <p className="text-gray-700">This is a lightweight starter kit using Go, Templ, Tailwind CSS, and HTMX.</p>

                <button
                    className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded transition"
                    onClick={() => setFact("Did you know? Tailwind makes styling fun and fast! ⚡")}
                >
                    Show Fun Fact 🤓
                </button>
